<template>
  ...
  >
    <div class="flex flex-row flex-wrap gap-4">
      <div
        v-for="{ id, linkTo, svg } in buttonList"
        :key="id"
        class="light-button"
      >
        <a :href="linkTo" target="_blank">
          <button class="bt">
            <div class="light-holder">
              <div class="dot" />
              <div :id="`${id}Light`" class="light" />
            </div>
            <div :id="`${id}Holder`" class="button-holder">
              <Tilt :options="options" :parallax="true" class="flex flex-col">
                <div class="flex justify-center" v-html="svg" />
                <p>{{ makeFirstLetterUppercase(id) }}</p>
              </Tilt>
            </div>
          </button>
        </a>
...
export default {
  ...
  data() {
    return {
      ...
      buttonList: [
        {
          linkTo: 'https://discordapp.com/users/gameboyfun#0079',
          id: 'discord',
          svg: `<svg
                  id="discord"
                  role="img"
        ...
        {
          linkTo: 'https://www.facebook.com/gameboyfun.blackfamily/',
          id: 'facebook',
          svg: `<svg
                  id="facebook"
                  role="img"
        ...
        {
          linkTo: 'https://github.com/gameboyfun',
          id: 'github',
          svg: `<svg
                  id="github"
                  role="img"
        ...
        {
          linkTo: 'https://www.instagram.com/gamexeres/',
          id: 'instagram',
          svg: `<svg
                  id="instagram"
                  role="img"
        ...
        {
          linkTo: 'https://www.linkedin.com/in/thipakorn-kaewsuwan-b6a9001ba/',
          id: 'linkedin',
          svg: `<svg
                  id="linkedin"
                  role="img"
        ...
        {
          linkTo: 'https://line.me/ti/p/e5mOUNLzXp',
          id: 'line',
          svg: `<svg
                  id="line"
                  role="img"
